      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-8 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            >
              {/* Анімація світіння/пульсації на фоні */}
            ...
            {/* Instagram (Пряме посилання та градієнт) */}
            <a
              href="https://www.instagram.com/detailermax?igsh=MTQzNzkzN253c3NmOA%3D%3D&utm_source=qr"
              target="_blank"
              rel="noopener noreferrer"
